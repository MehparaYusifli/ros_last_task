"""
PLATINUM-GRADE TELEMETRY NODE
-----------------------------
Task 2 & 3: Perception & Connectivity
Responsibility:
1.  Monitor camera stream health (Perception).
2.  Use 'Best Effort' QoS to prioritize low latency (Networking).
3.  Format data as JSON for the OpenMCT dashboard (Connectivity).
"""

import rclpy                                        # The standard ROS 2 Python library
from rclpy.node import Node                         # Class required to create a ROS node
